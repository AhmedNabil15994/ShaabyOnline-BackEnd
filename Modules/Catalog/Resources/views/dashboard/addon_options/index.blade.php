...
@section('title', __('catalog::dashboard.addon_options.routes.index'))
        ...
        <div class="page-content">
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="#">{{__('catalog::dashboard.addon_options.routes.index')}}</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="portlet light bordered">
                        ...
                        @permission('add_addon_options')
                        <div class="table-toolbar">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="btn-group">
                                        <a href="{{ url(route('dashboard.addon_options.create')) }}"
                        ...
                        <div class="portlet-body">
                            <table class="table table-striped table-bordered table-hover" id="dataTable">
                                ...
                                <tr>
                                    ...
                                    <th>#</th>
                                    <th>{{__('catalog::dashboard.addon_options.datatable.image')}}</th>
                                    <th>{{__('catalog::dashboard.addon_options.datatable.title')}}</th>
                                    <th>{{__('catalog::dashboard.addon_options.datatable.addon_category')}}</th>
                                    <th>{{__('catalog::dashboard.addon_options.datatable.price')}}</th>
                                    <th>{{__('catalog::dashboard.addon_options.datatable.created_at')}}</th>
                                    <th>{{__('catalog::dashboard.addon_options.datatable.options')}}</th>
                                </tr>
                                </thead>
                            </table>
                        </div>
                        <div class="row">
                            <div class="form-group">
                                <button type="submit" id="deleteChecked" class="btn red btn-sm"
                                        onclick="deleteAllChecked('{{ url(route('dashboard.addon_options.deletes')) }}')">
        ...
        function tableGenerate(data = '') {
            ...
            var dataTable =
                $('#dataTable').DataTable({
                    ...
                    ajax: {
                        url: "{{ url(route('dashboard.addon_options.datatable')) }}",
                        type: "GET",
                        data: {
                            req: data,
                        },
                    ...
                    columns: [
                        ...
                        {data: 'addon_category', className: 'dt-center', orderable: false},
...
responsivePriority:1,
                            width: '13%',
                            title: '{{__('catalog::dashboard.addon_options.datatable.options')}}',
                            className: 'dt-center',
                            orderable: false,
                            render: function (data, type, full, meta) {

                                // Edit
                                var editUrl = '{{ route("dashboard.addon_options.edit", ":id") }}';
                                editUrl = editUrl.replace(':id', data);

                                // Delete
                                var deleteUrl = '{{ route("dashboard.addon_options.destroy", ":id") }}';
                                deleteUrl = deleteUrl.replace(':id', data);

                                var deleteBtn = `
                                @permission('delete_addon_options')
                                @csrf
