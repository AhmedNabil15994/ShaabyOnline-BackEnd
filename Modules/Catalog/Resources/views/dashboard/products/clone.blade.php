                                    ...
                                    <div class="tab-content">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            <textarea name="description[{{ $code }}]" rows="8" cols="80" class="form-control {{ is_rtl($code) }}Editor"
                                                                data-name="description.{{ $code }}">{{ $product->getTranslation('description', $code) }}</textarea>
                                                            <div class="help-block"></div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="col-md-10">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="checkbox" class="make-switch" id="is_new"
                                                        data-size="small" name="is_new"
                                        ...
                                        <div class="col-md-10">
                                                    ...
                                                    <div class="form-check">
                                                        <span style="margin: 10px;">
                                                            ...
                                                            <label class="form-check-label">
                                                                <input type="radio" class="manageQty"
                                                                    name="manage_qty" value="unlimited"
                                                        ...
                                                        <span style="margin: 10px;">
                                                            ...
                                                            <label class="form-check-label">
                                                                <input type="radio" name="manage_qty"
                                                                    class="manageQty" value="limited"
                                                                    onchange="manageQty(this.value)"
                                                                    {{ !is_null($product->qty) ? 'checked' : '' }}>
                                            ...
                                            <div class="offer-form" style="display:none;">
                                                ...
                                                <div class="form-group" id="offerPercentageSection"
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="number" step="0.1" min="0" id="offer-percentage-form"
