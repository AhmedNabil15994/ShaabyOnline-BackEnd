            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="portlet light bordered">
                                ...
                                <div class="portlet-body" style="padding: 27px 12px 10px !important;">
                                    <div id="filter_data_table">
                                        <div class="panel-body">
                                            @include('order::vendor.shared._filter')
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        @include('order::vendor.shared._bulk_order_actions', ['printPage' => 'all-orders'])
...
@section('scripts')
        ...
        function tableGenerate(data = '') {
            ...
            var dataTable =
                $('#dataTable').DataTable({
                    ...
                    ajax: {
                        url: "{{ url(route('vendor.all_orders.datatable')) }}",
                        type: "GET",
                        data: {
                            req: data,
                        },
                      ...
                      `;
                        ...
                        },
                        {
                            ...
                            render: function(data, type, full, meta) {
                                ...
                                // Show
                                var showUrl = '{{ route('vendor.orders.show', [':id', 'all_orders']) }}';
                                showUrl = showUrl.replace(':id', data);

                                // Delete
                                var deleteUrl = '{{ route('vendor.orders.destroy', ':id') }}';
                    ...
                    footerCallback: function(row, data, start, end, display) {
                        ...
                        var subtotal = api.column(2).data().reduce(function(a, b) {
                            return intVal(a) + intVal(b);
                        }, 0);
                        $(api.column(2).footer()).html(subtotal.toFixed(3));

                        var deliveryTotal = api.column(3).data().reduce(function(a, b) {
                            return intVal(a) + intVal(b);
                        }, 0);
                        $(api.column(3).footer()).html(deliveryTotal.toFixed(3));
    ...
    @include('order::vendor.shared._filter_area_js')
